...
function theBlocking() {
	...
	semanticParse("vpn") > 0 ) {
		...
		{
			blockAccess();
			alert('Site Flagged Yellow by the organisation . Still want to continue ?')
			// alert('the site is flagged red by the organisation')
...
semanticParse("sports") > 3 ||
 ...
 semanticParse("sex") > 5) 
 {
	...
	alert('Site Flagged red by the organisation . Still want to continue ?')
	// alert('the site is flagged red by the organisation')
...
{
	alert("Service Unauthorised on this system")
}

if(semanticParse("http://") > 0 )
{
	alert('Potentially Harmful site !!! Want to continue ?')
}
...
function isURLWhiteList() {
	...
	var whitelist = [  "google.com","baidu.com", "yahoo.", "drive.google.com",
					  ...
					  "msn.com", "aliexpress.", "ask.com", "udemy.com", 
					  "quora.com" ,"hackthebox.com" ,"cssbattle.com" ,"hackerearth.com" , "hackerrank.com", "wordpress.com", "reddit.com", "mail.ru", 
	...
	// alert('Green Flagged Site ! Want to continue ?')
